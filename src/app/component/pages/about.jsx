      ...
      <div className="row align-items-center">
        ...
        <div className="col-md-8">
          <p>
            ...
            I enjoy solving real-world problems using modern web technologies like <strong>Next.js</strong>, <strong>React</strong>,<strong>Node.js</strong>, Expres.js <strong>MongoDB</strong>.
          </p>
          <p>
